  ...
  return (
    <div className="checkout-container">
      ...
      <div className="delivery-bar">
        ...
        <button className="change-link" onClick={() => setUseDifferentAddress(true)}>
          Change
        </button>
      </div>
      ...
      <div className="checkout-grid">
            ...
            {!useDifferentAddress ? (
              <div className="address-card">
                {customer.address ? (
                  ...
                  <p>No default address available. Please use the toggle above to add a new address.</p>
                )}
              </div>
            ) : (
        ...
        <aside className="checkout-sidebar">
          <section className="summary-section">
            ...
            {couponMessage && (
              <p className={`coupon-message ${couponMessage.includes('success') ? 'success' : 'error'}`}>
                {couponMessage}
              </p>
            )}
